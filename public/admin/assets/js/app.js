  ...
  function t(e) {
    1 == n("#light-mode-switch").prop("checked") && "light-mode-switch" === e
      ? (n("html").removeAttr("dir"),
        ...
        n("#app-style").attr("href", "/admin/assets/css/app.min.css"),
      ...
      ? (n("html").removeAttr("dir"),
        ...
        n("#app-style").attr("href", "/admin/assets/css/app-dark.min.css"),
      ...
      : 1 == n("#rtl-mode-switch").prop("checked") &&
        ...
        n("#app-style").attr("href", "/admin/assets/css/app-rtl.min.css"),
        n("html").attr("dir", "rtl"),
